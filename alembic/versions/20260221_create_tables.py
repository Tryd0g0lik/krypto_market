...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("best_bid_amount", sa.BigInteger(), nullable=True),
        sa.Column("best_ask_price", sa.BigInteger(), nullable=True),
        sa.Column("best_ask_amount", sa.BigInteger(), nullable=True),
