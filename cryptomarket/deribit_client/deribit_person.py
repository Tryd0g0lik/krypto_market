...
#         """
#
#         def __init__(self, _access_token, _refresh_token, _expires_in, person_id=None):
#             self.person_id = person_id
#             self.__access_token: str = _access_token
#             self.__refresh_token: str = _refresh_token
#             self.__expires_in: int = _expires_in
#
...
#
#     def add(self, _access_token, _refresh_token, _expires_in):
#         person = self.Person(_access_token, _refresh_token, _expires_in)
#
